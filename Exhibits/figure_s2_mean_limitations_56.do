* Figure S2 - Mean number of limitations by Group for 56 limitations included in algorithm
...
gen value3 = 0 
replace value3 = value2 if used_in_algorithm == 1
bys prim_key: egen num_limit_algorithm = total(value3>0)


collapse (max) num_limit_algorithm essential Teleworkable isco_1dig, by(prim_key)
...
anova num_limit_algorithm male [aw=weight]
...
anova num_limit_algorithm age_22_34 age_35_49 age_50_64 age_65_plus [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
anova num_limit_algorithm college [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
anova num_limit_algorithm goods [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
anova num_limit_algorithm managers professionals technicians clerical service_sales craft plant elementary [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
anova num_limit_algorithm essential [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
anova num_limit_algorithm Teleworkable [aw=weight]
// Get the F-statistic and degrees of freedom
local Fstat = e(F)
local df_m = e(df_m)
local df_r = e(df_r)
...
export excel using "Papers\Burdens of Functional Limitations\Exhibit 3\figure2_stars_sensitivity", firstrow(variables) replace
...
postfile mean_limitations_sensitivity str27 group mean_limit cilb ciub using mean_limitations_sensitivity , replace
...
foreach var of varlist male female age_22_34 age_35_49 age_50_64 age_65_plus college no_college service goods managers professionals technicians clerical service_sales craft plant elementary essential non_essential Teleworkable non_tele {
 ...
 preserve
  ...
  post mean_limitations_sensitivity ("`var'") (r(mean)) (r(lb)) (r(ub))
  
  restore
  
}

postclose mean_limitations_sensitivity
use mean_limitations_sensitivity , clear
...
text(1.8 15.75 "***", color(navy)) ///
text(5.8 15.75 "***", color(navy)) ///
text(9.7 15.75 "***", color(navy)) ///
...
graph export "Papers\Burdens of Functional Limitations\Exhibit 3\mean_limitations_by_demo_job_stars_sensitivity.png" , replace
